...
<head>
    ...
    <link href="statics/css/appinfolist.css" rel="stylesheet">
</head>
    ...
    <div class="left_col scroll-view">
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                <h3>${userSession.devCode}</h3>
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-home"></i> APP 账户管理 <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a><i class="fa fa-edit"></i> APP 应用管理 <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="dev/appinfo"> APP维护 </a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div class="sidebar-footer hidden-small">
            ...
            <a data-toggle="tooltip" data-placement="top" title="Logout" href="dev/loginout">
